...
public class DestroyedEnemyVehicle {
    ...
    private halo.model.Enemy Enemy;
     ...
     *     The Enemy
     */
    public halo.model.Enemy getEnemy() {
        return Enemy;
    }
     ...
     *     The Enemy
     */
    public void setEnemy(halo.model.Enemy Enemy) {
        this.Enemy = Enemy;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DestroyedEnemyVehicle) == false) {
            return false;
        }
        DestroyedEnemyVehicle rhs = ((DestroyedEnemyVehicle) other);
